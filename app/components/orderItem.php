<?php
    function renderOrderItem($order_id, $order_status, $product_img_url, $product_name, $product_category, $quantity, $product_price, $total){
        return "<div class='border mb-3 order-item'>
                    ...
                    <div class='d-flex p-3 border-top my-3'>
                        <img src='$product_img_url' alt='Fish' style='width: 80px; height: 80px;' class='me-3 rounded'>
