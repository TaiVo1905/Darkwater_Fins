...
<div style="background-color: #F4F4F4; height:100vh;">
    ...
    <div class="modal fade" id="confirmDeleteProduct" tabindex="-1" aria-labelledby="confirmDeleteProductLabel" aria-hidden="true">
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-footer">
              ...
              <button type="button" class="btn btn-primary" id="confirmDeleteProductButton">Confirm</button>
            </div>
          </div>
        </div>
    </div>
