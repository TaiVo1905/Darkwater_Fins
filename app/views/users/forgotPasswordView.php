...
<body>
    <div class="container-fluid container-background" id="forgottenPassword-form">
        ...
        <div class="d-flex align-items-center h-75">
            <div class="col-7">
                <div class="display-3 fw-bold text-white mx-auto p-5">Welcome, You can get your new password here!</div>
            </div>
            <form action="users/ForgottenPassword" method="POST" class= "col-4 mx-auto shadow px-3 py-5 rounded-3 needs-validation" novalidate>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    <input type="password" class="form-control form-control custom-opacity-form" id="user_password" name="user_password" placeholder="New password" minlength="8" required value="<?php echo isset($data["user_password"]) ? $data["user_password"] : "" ?>">
                    <div class="invalid-feedback">Password must be more than 8 characters</div>
                </div>
                <div class="mb-3">
                    <input type="password" class="form-control form-control custom-opacity-form" id="user_confirm_password" name="user_confirm_password" placeholder="New password confirmation" minlength="8" required value="<?php echo isset($data["user_confirm_password"]) ? $data["user_confirm_password"] : "" ?>">
                    <div class="invalid-feedback">Password must be more than 8 characters</div>
                </div>
                <div class="mb-3">
                    <div class="row g-3">
                ...
                <div class="d-grid">
                    <button type="submit" class="btn custom-btn-outline fw-bold">Confirm</button>
                </div>
                <h6 class="pt-3 text-center">Did you remember your password? <a href="users/SignIn" class="custom-color">Sign in</a></h6>
            </form>
        </div>
    </div>
