                ...
                <div class="row justify-content-center">
                    <div class="col-md-4 text-center">
                        <div class="product-card">
                            <img src="./public/images/backgroundFish/bg1.png" alt="Aquarium Image">
                            <i class="bi bi-bag"></i>
                        </div>
                    ...
                    <div class="col-md-4 text-center">
                        <div class="product-card">
                            <img src="./public/images/backgroundFish/bg2.jpg" alt="Fish Image">
                    ...
                    <div class="col-md-4 text-center">
                        <div class="product-card">
                            <img src="./public/images/backgroundFish/bg3.jpg" alt="Fish Food Image">
